...
| `docs/2026-05-20/v2_high_speed_back_emf_pending_scheme_deep_dive.md` | 高速反电动势、物理换挡、绕组重构、混合励磁边界的待定方案深度暂存；`engineering_validated=false` |
| `docs/2026-05-20/v2_high_speed_back_emf_pending_scheme_deep_dive.html` | 高速反电动势待定方案的 HTML 阅读版；不作为 FEA、台架、制造发布或量产验证证据 |
