...
| ID | 方案 | 目录 | 当前图纸包状态 |
|---|---|---|---|
| S01 | 负 d 轴弱磁 | `scheme-01/` | PCB 接口页和控制器状态机草图已落地，CAD/BOM/DVP 仍缺失 |
| S02 | MTPA/FW/MTPV 连续控制 | `scheme-02/` | PCB 接口页和控制器状态机草图已落地，CAD/BOM/DVP 仍缺失 |
| S03 | SVPWM/过调制 | `scheme-03/` | README 索引已建，图纸未落地 |
| S04 | 非线性磁链 LUT | `scheme-04/` | PCB 接口页和控制器状态机草图已落地，CAD/BOM/DVP 仍缺失 |
...
| S11 | 温度 / 退磁 / 安全保护 | `scheme-11/` | PCB 接口页和控制器状态机草图已落地，CAD/BOM/DVP 仍缺失 |
